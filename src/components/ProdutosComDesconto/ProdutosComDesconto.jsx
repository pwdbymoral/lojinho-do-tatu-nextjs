...
function ProdutosComDesconto() {
    return (
        <div className='container mx-auto my-4 px-4'>
            <span className='font-semibold text-xl'>Produtos com desconto</span>
            ...
            <div className="flex justify-end">
                <a href="" className="text-gray-500 lg:hover:text-gray-900 lg:hover:underline pr-2">Veja mais &gt;</a>
            </div>
        </div>
    )
}
